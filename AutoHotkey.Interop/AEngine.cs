...
namespace Kalih.Interop
{
    ...
    {
        public static AEngine Instance { get { return lazyInstance.Value; } }
        private static Lazy<AEngine> lazyInstance =
            new Lazy<AEngine>(() => new AEngine());

        private AEngine() {
            Util.ADllLoader.EnsureDllIsLoaded();
            ADll.ahktextdll("", "", "");
        }
        ...
        {
                var p = ADll.ahkgetvar(variableName, 0);
        ...
        public void SetVar(string variableName, string value)
        {
                ...
                ADll.ahkassign(variableName, value);
        }
        ...
        public void LoadFile(string filePath) {
            var absolute_file_path = Path.GetFullPath(filePath);
                ...
                //ADll.addFile(absolute_file_path, 1, 1);
                string script = File.ReadAllText(filePath);
                this.LoadScript(script);
        }

        public void LoadScript(string scriptText) {
                ADll.addScript(scriptText, ADll.Execute.RunWait);
        }
        /// <summary>
        ...
        public string ExecFunction(string functionName,
            ...
            string param10 = null)
        {
                IntPtr ret = ADll.ahkFunction(functionName, param1, param2, param3, param4, param5, param6, param7, param8, param9, param10);
        ...
        {
                IntPtr funcptr = ADll.ahkFindFunc(functionName);
        ...
        {
                IntPtr labelptr = ADll.ahkFindLabel(labelName);
